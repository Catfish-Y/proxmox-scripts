...
```bash
bash -c "$(wget --no-cache -qO- https://github.moeyy.xyz/https://raw.githubusercontent.com/Catfish-Y/proxmox-scripts/main/create.sh)"
```
...
```bash
bash -c "$(wget --no-cache -qO- https://github.moeyy.xyz/https://raw.githubusercontent.com/Catfish-Y/proxmox-scripts/main/create.sh)" -s --app nginx-proxy-manager --cleanup
```
...
```sh
sh -c "$(wget --no-cache -qO- https://github.moeyy.xyz/https://raw.githubusercontent.com/Catfish-Y/proxmox-scripts/main/install.sh)" -s --app nginx-proxy-manager
```
...
[Nginx Proxy Manager](https://github.com/Catfish-Y/proxmox-scripts/tree/main/apps/nginx-proxy-manager)
